...
public:
  ...
  // view as a homogeneous 4D vector (n.x, n.y, n.z, d) — was formerly an aliased union member
...
public :
	...
	// anonymous union above — provide them as accessors instead)
...
{
private:
  // was formerly a union aliasing (i,j,k,s) / (x,y,z,w) / (CVec3 n, float r) / CVec4 vec4 —
