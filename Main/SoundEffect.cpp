...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CSoundInstance::Pause( bool bPause )
{
	NFMSound::Pause( pSound, bPause );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
// retail @0x308eb0: every live instance node that IS a CSoundInstance freezes/resumes its channel
void CSoundEffect::Pause( bool bPause )
{
	for ( int i = 0; i < instances.size(); ++i )
	{
		if ( !IsValid( instances[i] ) )
			continue;
		CDynamicCast<CSoundInstance> pInst( instances[i].Get() );
		if ( pInst )
			pInst->Pause( bPause );
	}
}
